...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferReq', function() {
      beforeEach(function() {
        instance = new EmbersApi.TransferReq();
      });

      it('should create an instance of TransferReq', function() {
        // TODO: update the code to test TransferReq
        expect(instance).to.be.a(EmbersApi.TransferReq);
      });
